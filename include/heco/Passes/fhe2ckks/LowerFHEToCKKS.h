#ifndef HECO_PASSES_FHE2CKKS_LOWERFHETOCKKS_H_
#define HECO_PASSES_FHE2CKKS_LOWERFHETOCKKS_H_

#include "mlir/Pass/Pass.h"

struct LowerFHEToCKKSPass : public mlir::PassWrapper<LowerFHEToCKKSPass, mlir::OperationPass<>>
{
    void getDependentDialects(mlir::DialectRegistry &registry) const override;

    void runOnOperation() override;

    LowerFHEToCKKSPass() = default;
    LowerFHEToCKKSPass(const LowerFHEToCKKSPass &){}; // Necessary to make Options work
...
#endif // HECO_PASSES_FHE2CKKS_LOWERFHETOCKKS_H_